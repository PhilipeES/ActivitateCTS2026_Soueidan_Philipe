package ro.ase.cts.seminar12.unitTesting.clase;
...
public class Persoana implements IPersoana {
	...
	public int getVarsta(){
		...
		if(dataNasterii.before(dataCurenta)){
			...
			int varsta = dataCurenta.get(Calendar.YEAR) - dataNasterii.get(Calendar.YEAR);
			if (dataCurenta.get(Calendar.DAY_OF_YEAR) < dataNasterii.get(Calendar.DAY_OF_YEAR)) {
				varsta--;
			}
			return varsta;
		}
